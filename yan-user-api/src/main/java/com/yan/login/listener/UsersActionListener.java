...
@Component
@Slf4j
public class UsersActionListener implements SaTokenListener {
    ...
    public void doLogin(String loginType, Object loginId, String tokenValue, SaLoginParameter loginParameter) {
        ...
        dto.setDeviceType(DeviceType.valueOf(loginParameter.getDeviceType()));
        dto.setUserType(UserType.APP_USER);
        ...
        // 更新登录信息
//        userLoginService.recordLoginInfo((Long) loginParameter.getExtra(LoginHelper.USER_KEY), username, ip);
