 ...
 */
@Slf4j
@Service(IUserAuthStrategy.PREFIX + "Xcx" + IUserAuthStrategy.BASE_NAME)
@RequiredArgsConstructor
public class UserXcxAuthStrategy implements IUserAuthStrategy {
    ...
    public LoginUserVo login(String body, SysClientVo client) {
        ...
        UserVo user = loadUserByOpenid(openid);
        ...
        xcxLoginUser.setNickname(user.getNickName());
        xcxLoginUser.setUserType(user.getUserType());
        ...
        loginUserVo.setOpenid(openid);
        return loginUserVo;
    }

    private UserVo loadUserByOpenid(String openid) {
